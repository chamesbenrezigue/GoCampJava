...
public class Mailing {
    ...
    public String getPassword()
    {
      ...
      public String sendEmail(String toEmailAddress, String emailMessage) {
            String userName = "GoCamp315@gmail.com";
            String password = "xgqbqkchebjhabik";
            ...
            return emailMessage;
               ...
               public static void sendEmailRate(Session session, String toEmail, String subject, String body){
		try
	    {
	      ...
	      msg.setFrom(new InternetAddress("no_reply@example.com", "gocamp"));
